    ...
    <div className="text-center mb-10">
      ...
      <div className="h-[50vh] grid justify-center bg-[#072e33] text-white">
        ...
        <p className="lg:text-2xl md:w-[70vw] text-center lg:-mt-12 -mt-16 md:text-xl">
          "Education unlocks a world of opportunities and empowers students to
          shape their future. It nurtures critical thinking, creativity, and
          global awareness. Our institution is dedicated to unleashing
