        ...
        <div className="color shadow-md backdrop-blur-lg mt-[-2px] z-10 border-2 m-0 w-[100%] ">
          <div className="md:flex items-center justify-center py-4 md:px-10 px-7">
            <div className="color p-6 rounded-md text-white text-center h-[40vh]">
              <h1 className="font-bold text-8xl sm:text-2xl md:text-4xl mt-10">
                AKAL COLLEGE OF ENGINEERING AND TECHNOLOGY
              </h1>
              <h2 className="font-bold mt-10 font-2xl">
                Kalgidhar Trust is a premier organization of universal
                brotherhood, was the main force behind the mission of “Removal
                of Economic Backwardness through Technology”.
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className=" shadow-md backdrop-blur-lg mt-[-2px] z-10 border-2 m-0 w-[100%] ">
          <div className="md:flex items-center justify-center py-4 md:px-10 px-7">
            <div className="p-6 rounded-md text-white text-center h-[50vh]">
              <h1 className=" brown font-bold text-4xl sm:text-xl md:text-2xl ">
                COURSES
              </h1>
            </div>
          </div>
